            ...
            {databases.map((db, index) => (
              <tr key={index}>
                ...
                <td className="px-4 md:px-6 py-4 text-sm bg-gray-800">
                  <span className={`px-2 py-1 rounded-full text-xs font-bold ${db.status === "active" ? "bg-green-500 text-white" : "bg-red-500 text-white"
                    }`}>
                    {db.status}
                  </span>
                </td>
                ...
                <td className="hidden lg:table-cell px-4 md:px-6 py-4 text-sm text-white bg-gray-800">
                  <button
                    onClick={async () => {
                      try {
